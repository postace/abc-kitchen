    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="abckitchenApp.ingredient.home.createOrEditLabel">
              <Translate contentKey="abckitchenApp.ingredient.home.createOrEditLabel">Create or edit a Ingredient</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
