...
export class Ingredient extends React.Component<IIngredientProps, IIngredientState> {
  ...
  render() {
    const { ingredientList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="ingredient-heading">
          <Translate contentKey="abckitchenApp.ingredient.home.title">Ingredients</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="abckitchenApp.ingredient.home.createLabel">Create new Ingredient</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="abckitchenApp.ingredient.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('unit')}>
                  <Translate contentKey="abckitchenApp.ingredient.unit">Unit</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
